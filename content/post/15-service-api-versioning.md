...
# แต่ความเปลี่ยนแปลงมันห้ามกันไม่ได้ (Change is Inevitable)

> "ทำไมเธอเปลี่ยนไป ไม่เหมือนตอนที่คบกันใหม่ๆ" -- ทุกความสัมพันธ์ในโลก

ในชีวิตจริง ยังไง Service API ก็ต้องมีการเปลี่ยนแปลง แต่ข้อตกลงที่เราเคยให้สัญญากับผู้ใช้เอาไว้ มันเปลี่ยนแปลงไม่ได้ง่ายๆ ถ้าหากเราไม่ปฏิบัติตามข้อตกลงนี้ ระบบของผู้ใช้อาจจะล่มเอาง่ายๆได้

ดังนั้น การทำ Service API ให้ Backward-Compatible เพื่อรักษาพันธะที่เราเคยให้ไว้นั้นสำคัญมาก

> "ความรักออกแบบไม่ได้ แต่ Backward-Compatibility ออกแบบได้" -- ijemmy, notaboutcode.com

ดังนั้น เรามาออกแบบมันให้ดีตั้งแต่แรกเถอะ บทความนี้จะพูดถึงเรื่องที่ต้องรู้ในการออกแบบ Service API มีคุณสมบัติเป็น Backward Compatibility ครับ

# ความสำคัญและนิยามของ Backward-Compatible

ถ้าเปิดดิกดู เราจะได้นิยามดังนี้ครับ

> Backward-Compatible : able to be used with an older piece of software without special adaptation or modification.

ในบริบทของเซอร์วิซ Backward-Compaitible หมายถึงผู้ใช้ (Client) ต้องไม่ได้รับผลกระทบอะไรหากมีการเปลี่ยนแปลงของ Service API

เพื่อให้เห็นความสำคัญของคุณสมบัตินี้ ยกตัวอย่าง คุณจะอัพเกรด v1 เป็น v2 ซึ่งจะส่งข้อมูลในรูปแบบใหม่ (ไม่ Backward-Compatible) ถ้าผู้ใช้ยังต้องการใช้เซอร์วิซของคุณอยู่ จะต้องทำการแก้โค้ดให้ใช้งานกับ v2 ได้

ในทางปฏิบัติ ผู้ใช้จะต้องเขียนโค้ดให้รองรับทั้ง v1 และ v2 เนื่องจาก Deployment Dependency  ลองดูตารางนี้ครับ
...
4. ถ้าหากคุณกำลังพัฒนา v3 อยู่จะเอาไปเทสต์ทีไ่หน?
...
ผมชอบวิธีนี้มาก เพราะแค่ดู URI ปุ๊บ ผมก็รู้เลยว่าเรียกเวอร์ชั่นไหน ดีบั้กง่าย แต่เพื่อนร่วมทีมผมด่าเช็ดเลยครับ บอกว่า นี่มันไม่ [RESTful](https://en.wikipedia.org/wiki/Representational_state_transfer#Resource_identification_in_requests) เลย เพราะผมดันเอาเวอร์ชั่นไปใส่ใน URI  ฮัสกี้สามตัวไม่ได้เปลี่ยน แค่ข้อมูลที่ผมส่งกลับเปลี่ยน ดังนั้น ตามหลักการของ REST ผมควรจะส่งทาง header อย่างนี้ต่างหาก
...
พอดีไซน์แบบนี้ เพื่อนร่วมทีมผมก็สามารถนอนหลับฝันดี โดยไม่กังวลต่อคำติฉินนินทาของชาว RESTful แต่อย่างใด แต่เดี๋ยวก่อน เพื่อนร่วมทีมอีกคนกลับไม่คิดเช่นนั้น
...
ใครอยากฟังคนเถียงกันต่อ ในกูเกิ้ลมีเพียบเลยครับ ลองไปหาดู สำหรับผม ถ้าเข้าใจข้อดีข้อเสียและ Requirement ของ API ชัดเจน อยากเลือกไรก็เลือกไปเถอะครับ เสียเวลาเขียนโค้ด
