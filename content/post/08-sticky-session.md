...
> **Note** จริงๆแล้ววิธีนี้อาจแก้ด้วยการกระจาย Load แบบวิธีอื่นๆแทนที่จะกระจายเท่าๆกันตลอด (เช่น กระจายไปให้ตัวที่ Latency ต่ำที่สุด) แต่ก็ไม่สามารถการันตีได้อยู่ดีว่า Load จะได้กระจายออกไปเท่าๆกัน
...
โดยส่วนตัวแล้วผมไม่แนะนำให้ใช้ Sticky Session ใน Layer ของ Web Server เลย  เพราะพอระบบสเกลขึ้นรับโหลดเยอะๆแล้วผลดีไม่คุ้มกับผลเสีย
